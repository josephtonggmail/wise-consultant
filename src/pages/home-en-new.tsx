...
const courses = [
  {
    id: "ai-leadership",
    title: "AI Leadership & Strategic Thinking",
    desc: "Human-AI Collaboration & Decision Making Workshop",
  ...
  {
    id: "neuroscience",
    title: "Neuroscience & Emotional Management",
    desc: "Understand brain functions, master emotional intelligence",
  ...
  {
    id: "psychic",
    title: "Awareness & Mind Reading Communication",
    desc: "Read people, enhance communication effectiveness",
...
export default function HomeEnNew() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link to="/en" className="text-sm font-medium text-purple-600">
                Home
              </Link>
              <Link to="/en/about" className="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors">
                About
              </Link>
              <Link to="/en/services" className="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors">
                Services
              </Link>
              <Link to="/en/courses" className="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors">
                Courses
              </Link>
              <Link to="/en/contact" className="text-sm font-medium text-gray-700 hover:text-purple-600 transition-colors">
                Contact
              </Link>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
              ...
              Professional Neuroscience Consultancy
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Neuroscience-Based Leadership
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                Empowering Organizations & Individuals
              </span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: Brain,
                title: "Neuroscience Consulting",
                desc: "Optimize decisions and leadership using brain science",
              },
              {
                icon: Users,
                title: "Corporate Training",
                desc: "Build high-performance team culture",
              },
              {
                icon: Heart,
                title: "Personal Coaching",
                desc: "Break through barriers and achieve goals",
              },
            ].map((service, i) => (
              <div
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-sm">
              © 2024 WISE Consultant Asia. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
