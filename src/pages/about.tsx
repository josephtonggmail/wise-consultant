    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative pt-16 pb-20 bg-gradient-to-br from-[#4D21D0] to-[#6B3DD4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 pt-12">企業概覽</h1>
          <p className="text-white/70 text-lg">神經科學 × 心理學 × 商業智慧</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">關於 WISE</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                WISE Consultant Asia 成立於神經科學與心理學的交叉領域，致力於為企業與個人提供基於科學的專業顧問服務。我們相信，真正的改變來自於對人類大腦與行為的深入理解。
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                我們的顧問團隊由神經科學博士、心理學專家與企業管理顧問組成，融合學術深度與實踐經驗，幫助組織在複雜多變的商業環境中保持競爭力與韌性。
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">我們的核心價值</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Brain, title: "科學嚴謹", desc: "所有方法論均基於神經科學研究與循證實踐，確保干預的有效性與持久性" },
              { icon: Users, title: "以人為本", desc: "深度理解每個組織與個人的獨特需求，提供定制化解决方案" },
              { icon: Lightbulb, title: "創新實用", desc: "在學術深度與商業應用之間取得平衡，提供可落地執行的工具與方法" },
            ].map((item, i) => (
